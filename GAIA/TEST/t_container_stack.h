#ifndef		__T_CONTAINER_STACK_H__
#define		__T_CONTAINER_STACK_H__

namespace GAIA_TEST
{
	GINL GAIA::N32 t_container_stack(GAIA::FSYS::File& file, GAIA::PRINT::PrintBase& prt)
	{
		GAIA::N32 nRet = 0;
		typedef GAIA::CTN::BasicStack<GAIA::N32, GAIA::N32, GAIA::ALGO::TwiceSizeIncreaser<GAIA::N32> > __StackType;
		__StackType s;
		s.reserve(100);
		if(s.capacity() != 100)
		{
