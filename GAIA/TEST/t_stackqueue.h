#ifndef		__T_STACKQUEUE_H__
#define		__T_STACKQUEUE_H__

namespace GAIATEST
{
	GINL GAIA::N32 t_stackqueue(GAIA::FILESYSTEM::File& file, GAIA::PRINT::PrintBase& prt)
	{
		GAIA::N32 nRet = 0;
		typedef GAIA::CONTAINER::BasicStackQueue<GAIA::N32, GAIA::N32, 100> __StackQueueType;
		__StackQueueType sq;
		if(sq.capacity() != 100)
		{
