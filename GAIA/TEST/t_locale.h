...
namespace GAIATEST
{
	GINL GAIA::N32 t_locale(GAIA::FILESYSTEM::File& file, GAIA::PRINT::PrintBase& prt)
	{
		GAIA::N32 nRet = 0;
		...
		if(GAIA::LOCALE::m2w(szEnglishDst, GNULL, 0, GAIA::CHARSET_TYPE_ANSI) != uStringLen)
		{
		...
		if(GAIA::LOCALE::m2w(szEnglishDst, GNULL, 0, GAIA::CHARSET_TYPE_SYS) != uStringLen)
		{
		...
		if(GAIA::LOCALE::m2w(szEnglishDst, GNULL, 0, GAIA::CHARSET_TYPE_UTF7) != uStringLen)
		{
		...
		if(GAIA::LOCALE::m2w(szEnglishDst, GNULL, 0, GAIA::CHARSET_TYPE_UTF8) != uStringLen)
		{
