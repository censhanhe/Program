...
namespace GAIA
{
	namespace CONTAINER
	{
		...
		public:
			...
			GINL GAIA::BL zero() const{return GAIA::ALGORITHM::xmemcheck(this->front_ptr(), 0, _Size) == 0;}
			GINL GAIA::BL one() const{return GAIA::ALGORITHM::xmemcheck(this->front_ptr(), 0xFF, _Size) == 0;}
