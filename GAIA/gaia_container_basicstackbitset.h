...
namespace GAIA
{
	namespace CONTAINER
	{
		...
		public:
			...
			GINL GAIA::GVOID inverse(const _SizeType& index){GAIA_BITSET_SRC ^= ((~GAIA_BITSET_SRC) | GAIA_BITSET_CUR);}
			...
			GINL BasicStackBitset<_SizeType, _Size>& operator += (const _SizeType& index){return *this;}
			GINL BasicStackBitset<_SizeType, _Size>& operator += (const BasicStackBitset<_SizeType, _Size>& src){return *this;}
			GINL BasicStackBitset<_SizeType, _Size>& operator -= (const _SizeType& index){return *this;}
			GINL BasicStackBitset<_SizeType, _Size>& operator -= (const BasicStackBitset<_SizeType, _Size>& src){return *this;}
