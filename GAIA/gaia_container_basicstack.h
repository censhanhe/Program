...
namespace GAIA
{
	namespace CTN
	{
		...
		public:
			...
			{
			private:
				friend class GAIA::CTN::BasicStack;
			public:
				GINL it(){this->init();}
				GINL virtual ~it(){}
		...
		public:
			...
			GINL ~BasicStack(){if(m_pFront != GNIL) delete[] m_pFront;}
			...
			GINL GAIA::GVOID destroy(){if(m_pFront != GNIL){delete[] m_pFront; m_pFront = GNIL; m_capacity = m_size = 0;}}
