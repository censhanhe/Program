...
namespace GAIA
{
	namespace PRINT
	{
		...
		GAIA_DEBUG_CODEPURE_MEMFUNC Print& Print::operator >> (PrintFormat& pf)
		{
			pf = m_pf;
			return *this;
		}
		GAIA_DEBUG_CODEPURE_MEMFUNC Print& Print::operator << (const PrintFormat& pf)
		{
		...
		GAIA_DEBUG_CODEPURE_MEMFUNC GAIA::GVOID Print::flush()
		{
			std::cout << std::flush;
		}
	};
