...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> __MyType operator * (const GAIA::MATH::MTX44<_ParamDataType>& src) const{__MyType ret; ret = *this; ret *= src; return ret;}
			template<typename _ParamDataType> __MyType operator * (const GAIA::MATH::MTX34<_ParamDataType>& src) const{__MyType ret; ret = *this; ret *= src; return ret;}
			template<typename _ParamDataType> __MyType operator * (const GAIA::MATH::MTX33<_ParamDataType>& src) const{__MyType ret; ret = *this; ret *= src; return ret;}
			template<typename _ParamDataType> __MyType operator * (const GAIA::MATH::MTX22<_ParamDataType>& src) const{__MyType ret; ret = *this; ret *= src; return ret;}
