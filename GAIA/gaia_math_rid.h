...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> GAIA::GVOID fromstring(const _ParamDataType* psz){GAIA::ALGORITHM::str2hex(psz, sizeofarray(u), u);}
			template<typename _ParamDataType> GAIA::GVOID tostring(_ParamDataType* psz){GAIA::ALGORITHM::hex2str(u, sizeofarray(u), psz);}
