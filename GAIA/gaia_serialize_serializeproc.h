...
namespace GAIA
{
	namespace SERIALIZER
	{
		...
		public:
			/* Base type serialize. */
			template<typename _ParamType> GINL GAIA::BL write(Serializer* p, const _ParamType& t);
		...
		private: // Protect for 32-64bit error.
			...
			GINL GAIA::BL write(Serializer* p, const GAIA::GWCH& t);
			GINL GAIA::BL read(Serializer* p, GAIA::GWCH& t);
		};
	#endif
	};
};
