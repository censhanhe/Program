...
#	endif
	...
	static const GAIA::WCH* CHARSET_CODEPAGE_NAMEW[] =
	{
		...
		L"",		// CHARSET_TYPE_SYS
		L"ASCII",	// CHARSET_TYPE_ANSI
		L"UTF-7",	// CHARSET_TYPE_UTF7
		L"UTF-8",	// CHARSET_TYPE_UTF8
		L"UTF-16LE",// CHARSET_TYPE_UTF16LE
		L"UTF-16BE",// CHARSET_TYPE_UTF16BE
	};
