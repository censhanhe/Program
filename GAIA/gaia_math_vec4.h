...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> __MyType& operator *= (const _ParamDataType& v){x *= v; y *= v; z *= v; w *= v; return *this;}
			template<typename _ParamDataType> __MyType& operator /= (const _ParamDataType& v){x /= v; y /= v; z /= v; w /= v; return *this;}
			template<typename _ParamDataType> __MyType& operator = (const GAIA::MATH::VEC4<_ParamDataType>& v){x = (_DataType)v.x; y = (_DataType)v.y; z = (_DataType)v.z; w = (_DataType)v.w; return *this;}
			...
			template<typename _ParamDataType> GAIA::BL operator == (const GAIA::MATH::VEC4<_ParamDataType>& v) const{return GAIA::ALGORITHM::cmp4((const _DataType*)*this, (const _ParamDataType*)v) == 0;}
