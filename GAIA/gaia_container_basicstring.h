...
namespace GAIA
{
	namespace CONTAINER
	{
		...
		public:
			...
			GINL GAIA::BL rleft(const _SizeType& index) const;
			GINL GAIA::BL rright(const _SizeType& index) const;
			GINL GAIA::BL rmid(const _SizeType& index) const;
			GINL GAIA::BL rleft(const _DataType& t);
			GINL GAIA::BL rleft(const _DataType* p);
			GINL GAIA::BL rleft(const BasicString<_DataType, _SizeType>& src);
			GINL GAIA::BL rright(const _DataType& t);
			GINL GAIA::BL rright(const _DataType* p);
			GINL GAIA::BL rright(const BasicString<_DataType, _SizeType>& src);
