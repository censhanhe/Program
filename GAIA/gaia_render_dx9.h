	...
	namespace RENDER
	{
		...
		public:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_CONTEXT;}
			private:
				ContextDesc m_desc;
			};
		...
		public:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_PEN;}
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_BRUSH;}
				virtual GAIA::BL SetColor(const GAIA::MATH::ARGB<GAIA::REAL>& cr){return GAIA::False;}
				virtual GAIA::BL GetColor(GAIA::MATH::ARGB<GAIA::REAL>& cr) const{return GAIA::False;}
			private:
				BrushDesc m_desc;
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_FONTFAMILY;}
			private:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_FONTPAINTER;}
			private:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_FONTFORMAT;}
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_TARGET;}
			private:
				TargetDesc m_desc;
			};
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_SHADER;}
			private:
				ShaderDesc m_desc;
			};
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_TEXTURE;}
			private:
				TextureDesc m_desc;
			};
		...
		public:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_VERTEXDECLARATION;}
			private:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_INDEXBUFFER;}
			private:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX9_VERTEXBUFFER;}
			private:
