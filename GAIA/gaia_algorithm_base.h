...
namespace GAIA
{
	namespace ALGORITHM
	{
		...
		template<typename _DataType1, typename _DataType2, typename _SizeType> GINL GAIA::GVOID move_prev(_DataType1 dst, _DataType2 src, const _SizeType& size)
		{
		...
		template<typename _DataType1, typename _DataType2, typename _SizeType> GINL GAIA::GVOID move_next(_DataType1 dst, _DataType2 src, const _SizeType& size)
		{
			_SizeType sizetemp = size;
			while(sizetemp > 0)
			{
