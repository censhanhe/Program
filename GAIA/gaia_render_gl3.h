...
#if defined(GAIA_PLATFORM_OPENGL3)
#	include <gl/gl.h>
#endif
...
namespace GAIA
{
	namespace RENDER
	{
		...
		public:
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render::Context::ContextDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Context::ContextDesc&)(desc);
					return GAIA::True;
				}
		...
		public:
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Pen::PenDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Pen::PenDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Brush::BrushDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Brush::BrushDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::FontFamily::FontFamilyDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::FontFamily::FontFamilyDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::FontPainter::FontPainterDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::FontPainter::FontPainterDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::FontFormat::FontFormatDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::FontFormat::FontFormatDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Target::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GL3_TARGETFETCHDATA;}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Target::TargetDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Target::TargetDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Shader::ShaderDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Shader::ShaderDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Texture::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual const GAIA::FAVO::FetchData::FetchDataDesc& GetDesc() const{return m_desc;}
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GL3_TEXTUREFETCHDATA;}
					virtual GAIA::SIZE GetSize() const
					{
						return GNIL;
					}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Texture::TextureDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::Texture::TextureDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
		...
		public:
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render3D::VertexDeclaration::VertexDeclarationDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::VertexDeclaration::VertexDeclarationDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::IndexBuffer::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual const GAIA::FAVO::FetchData::FetchDataDesc& GetDesc() const{return m_desc;}
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GL3_INDEXBUFFERFETCHDATA;}
					virtual GAIA::SIZE GetSize() const
					{
						return GNIL;
					}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render3D::IndexBuffer::IndexBufferDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::IndexBuffer::IndexBufferDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::VertexBuffer::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual const GAIA::FAVO::FetchData::FetchDataDesc& GetDesc() const{return m_desc;}
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GL3_VERTEXBUFFERFETCHDATA;}
					virtual GAIA::SIZE GetSize() const
					{
						return GNIL;
					}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render3D::VertexBuffer::VertexBufferDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::VertexBuffer::VertexBufferDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
		...
		public:
			...
			GINL ~Render3DGL3(){if(this->IsCreated()) this->Destroy();}
			...
			virtual GAIA::BL Create(const GAIA::RENDER::Render::RenderDesc& desc)
			{
				...
				m_desc = GDCAST(const GAIA::RENDER::Render3DGL3::RenderDesc&)(desc);
			...
			#if defined(GAIA_PLATFORM_OPENGL3)
				Context* pContext = GDCAST(Context*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_CONTEXT, GNIL));
		...
		public:
			...
			virtual GAIA::RENDER::Render2D::Pen* CreatePen(GAIA::RENDER::Render::Context& ctx, const GAIA::RENDER::Render2D::Pen::PenDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGL3)
				Pen* pPen = GDCAST(Pen*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_PEN, GNIL));
				GAIA_AST(pPen != GNIL);
				if(pPen == GNIL)
					return GNIL;
				pPen->SetRender(this);
			...
			virtual GAIA::RENDER::Render2D::Brush* CreateBrush(GAIA::RENDER::Render::Context& ctx, const GAIA::RENDER::Render2D::Brush::BrushDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGL3)
				Brush* pBrush = GDCAST(Brush*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_BRUSH, GNIL));
				...
				const GAIA::RENDER::Render2D::FontFamily::FontFamilyDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGL3)
				FontFamily* pFontFamily = GDCAST(FontFamily*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_FONTFAMILY, GNIL));
				...
				const GAIA::RENDER::Render2D::FontPainter::FontPainterDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGL3)
				FontPainter* pFontPainter = GDCAST(FontPainter*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_FONTPAINTER, GNIL));
				...
				const GAIA::RENDER::Render2D::FontFormat::FontFormatDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGL3)
				FontFormat* pFontFormat = GDCAST(FontFormat*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_FONTFORMAT, GNIL));
				...
				const GAIA::RENDER::Render2D::Texture::TextureDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGL3)
				Texture* pTex = GDCAST(Texture*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GL3_TEXTURE, GNIL));
				GAIA_AST(pTex != GNIL);
				if(pTex == GNIL)
					return GNIL;
				pTex->SetRender(this);
