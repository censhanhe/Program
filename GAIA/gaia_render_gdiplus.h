		...
		public:
			...
			virtual GAIA::GVOID SetQuality2DState(GAIA::RENDER::Render::Context* pContext, const QUALITY2D_STATE& qs, const GAIA::CH* pszState)
			{
				...
				if(GAIA::ALGO::stremp(pszState))
					this->SetQuality2DState(pContext, qs, RENDER2D_QUALITYSTATE_DEFAULT[qs]);
				switch(qs)
				{
			...
			virtual const GAIA::CH* GetQuality2DState(GAIA::RENDER::Render::Context* pContext, const QUALITY2D_STATE& qs)
			{
				if(!GAIA_ENUM_VALID(QUALITY2D_STATE, qs))
					return GNILSTR;
				switch(qs)
			...
			virtual GAIA::GVOID SetRender2DState(GAIA::RENDER::Render::Context* pContext, const RENDER2D_STATE& rs, const GAIA::CH* pszState)
			{
				if(!GAIA_ENUM_VALID(RENDER2D_STATE, rs))
					return;
				if(GAIA::ALGO::stremp(pszState))
					this->SetRender2DState(pContext, rs, RENDER2D_RENDERSTATE_DEFAULT[rs]);
				switch(rs)
				{
			...
			virtual const GAIA::CH* GetRender2DState(GAIA::RENDER::Render::Context* pContext, const RENDER2D_STATE& rs) const
			{
				if(!GAIA_ENUM_VALID(RENDER2D_STATE, rs))
					return GNILSTR;
				switch(rs)
			...
			virtual GAIA::GVOID SetSampler2DState(GAIA::RENDER::Render::Context* pContext, GAIA::N32 nSamplerIndex, const SAMPLER2D_STATE& ss, const GAIA::CH* pszState)
			{
				if(!GAIA_ENUM_VALID(SAMPLER2D_STATE, ss))
					return;
				if(GAIA::ALGO::stremp(pszState))
					this->SetSampler2DState(pContext, nSamplerIndex, ss, RENDER2D_SAMPLERSTATE_DEFAULT[ss]);
				switch(ss)
				{
			...
			virtual const GAIA::CH* GetSampler2DState(GAIA::RENDER::Render::Context* pContext, GAIA::N32 nSamplerIndex, const SAMPLER2D_STATE& ss) const
			{
				if(!GAIA_ENUM_VALID(SAMPLER2D_STATE, ss))
					return GNILSTR;
				switch(ss)
			...
			/* Pen. */
			virtual GAIA::RENDER::Render2D::Pen* CreatePen(GAIA::RENDER::Render::Context* pContext, const GAIA::RENDER::Render2D::Pen::PenDesc& desc)
			{
				GPCHR_NULL_RET(this->GetFactory(), GNIL);
			#if GAIA_OS == GAIA_OS_WINDOWS && defined(GAIA_PLATFORM_GDIPLUS)
			...
			/* Brush. */
			virtual GAIA::RENDER::Render2D::Brush* CreateBrush(GAIA::RENDER::Render::Context* pContext, const GAIA::RENDER::Render2D::Brush::BrushDesc& desc)
			{
				GPCHR_NULL_RET(this->GetFactory(), GNIL);
			#if GAIA_OS == GAIA_OS_WINDOWS && defined(GAIA_PLATFORM_GDIPLUS)
				...
				GAIA::RENDER::Render2D::Pen* pPen)
			{
				...
				const GAIA::CH* pszAlphaBlendState = this->GetRender2DState(pContext, GAIA::RENDER::Render2D::RENDER2D_STATE_ALPHABLEND);
