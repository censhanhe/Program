...
#if defined(GAIA_PLATFORM_OPENGLES2)
#	include <gl/gl.h>
#endif
...
namespace GAIA
{
	namespace RENDER
	{
		...
		public:
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render::Context::ContextDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Context::ContextDesc&)(desc);
					return GAIA::True;
				}
		...
		public:
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Pen::PenDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Pen::PenDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Brush::BrushDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Brush::BrushDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::FontFamily::FontFamilyDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::FontFamily::FontFamilyDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::FontPainter::FontPainterDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::FontPainter::FontPainterDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::FontFormat::FontFormatDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::FontFormat::FontFormatDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Target::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GLES2_TARGETFETCHDATA;}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Target::TargetDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Target::TargetDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Shader::ShaderDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Shader::ShaderDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Texture::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual const GAIA::FAVO::FetchData::FetchDataDesc& GetDesc() const{return m_desc;}
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GLES2_TEXTUREFETCHDATA;}
					virtual GAIA::SIZE GetSize() const
					{
						return GNIL;
					}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render2D::Texture::TextureDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::Texture::TextureDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
		...
		public:
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render3D::VertexDeclaration::VertexDeclarationDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::VertexDeclaration::VertexDeclarationDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::IndexBuffer::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual const GAIA::FAVO::FetchData::FetchDataDesc& GetDesc() const{return m_desc;}
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GLES2_INDEXBUFFERFETCHDATA;}
					virtual GAIA::SIZE GetSize() const
					{
						return GNIL;
					}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render3D::IndexBuffer::IndexBufferDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::IndexBuffer::IndexBufferDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
			...
			public:
				...
				public:
					...
					virtual GAIA::BL Create(const GAIA::FAVO::FetchData::FetchDataDesc& desc)
					{
						if(!desc.check())
							return GAIA::False;
						m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::VertexBuffer::FetchData::FetchDataDesc&)(desc);
						return GAIA::True;
					}
					virtual GAIA::GVOID Destroy()
					{
					...
					virtual const GAIA::FAVO::FetchData::FetchDataDesc& GetDesc() const{return m_desc;}
					virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GLES2_VERTEXBUFFERFETCHDATA;}
					virtual GAIA::SIZE GetSize() const
					{
						return GNIL;
					}
			...
			public:
				...
				virtual GAIA::BL Create(const GAIA::RENDER::Render3D::VertexBuffer::VertexBufferDesc& desc)
				{
					if(!desc.check())
						return GAIA::False;
					m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::VertexBuffer::VertexBufferDesc&)(desc);
					return GAIA::True;
				}
				virtual GAIA::GVOID Destroy()
				{
		...
		public:
			...
			GINL ~Render3DGLES2(){if(this->IsCreated()) this->Destroy();}
			...
			virtual GAIA::BL Create(const GAIA::RENDER::Render::RenderDesc& desc)
			{
				...
				m_desc = GDCAST(const GAIA::RENDER::Render3DGLES2::RenderDesc&)(desc);
			...
			#if defined(GAIA_PLATFORM_OPENGLES2)
				Context* pContext = GDCAST(Context*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_CONTEXT, GNIL));
		...
		public:
			...
			virtual GAIA::GVOID SetQuality2DState(GAIA::RENDER::Render::Context& ctx, const QUALITY2D_STATE& qs, const GAIA::CH* pszState)
			{
				...
				if(!GAIA_ENUM_VALID(QUALITY2D_STATE, qs))
					return;
				GAIA::RENDER::Render3DGLES2::Context* pContext = GDCAST(GAIA::RENDER::Render3DGLES2::Context*)(&ctx);
				if(pContext == GNIL)
					return;
			...
			virtual GAIA::RENDER::Render2D::Pen* CreatePen(GAIA::RENDER::Render::Context& ctx, const GAIA::RENDER::Render2D::Pen::PenDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGLES2)
				Pen* pPen = GDCAST(Pen*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_PEN, GNIL));
				GAIA_AST(pPen != GNIL);
				if(pPen == GNIL)
					return GNIL;
				pPen->SetRender(this);
			...
			virtual GAIA::RENDER::Render2D::Brush* CreateBrush(GAIA::RENDER::Render::Context& ctx, const GAIA::RENDER::Render2D::Brush::BrushDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGLES2)
				Brush* pBrush = GDCAST(Brush*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_BRUSH, GNIL));
				...
				const GAIA::RENDER::Render2D::FontFamily::FontFamilyDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGLES2)
				FontFamily* pFontFamily = GDCAST(FontFamily*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_FONTFAMILY, GNIL));
				...
				const GAIA::RENDER::Render2D::FontPainter::FontPainterDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGLES2)
				FontPainter* pFontPainter = GDCAST(FontPainter*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_FONTPAINTER, GNIL));
				...
				const GAIA::RENDER::Render2D::FontFormat::FontFormatDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGLES2)
				FontFormat* pFontFormat = GDCAST(FontFormat*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_FONTFORMAT, GNIL));
				...
				const GAIA::RENDER::Render2D::Texture::TextureDesc& desc)
			{
				...
				if(pContext == GNIL)
					return GNIL;
			#if defined(GAIA_PLATFORM_OPENGLES2)
				Texture* pTex = GDCAST(Texture*)(this->GetFactory()->CreateInstance(GAIA::FWORK::CLSID_RENDER_3D_GLES2_TEXTURE, GNIL));
				GAIA_AST(pTex != GNIL);
				if(pTex == GNIL)
					return GNIL;
				pTex->SetRender(this);
