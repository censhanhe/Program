#ifndef		__GAIA_RENDER_GLES2_H__
#define		__GAIA_RENDER_GLES2_H__

namespace GAIA
{
	namespace RENDER
	{
		class Render3DGLES2 : public virtual GAIA::RENDER::Render3D
		{
		public:
		...
		public:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GLES2_CONTEXT;}
			private:
				ContextDesc m_desc;
			};
		...
		public:
			GINL Render3DGLES2(){this->init();}
			GINL ~Render3DGLES2(){}

			virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_GLES2;}
