...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> GAIA::BL operator == (const GAIA::MATH::VEC3<_ParamDataType>& v) const{return GAIA::ALGO::cmp3(GSCAST(const _DataType*)(*this), GSCAST(const _ParamDataType*)(v)) == 0;}
			template<typename _ParamDataType> GAIA::BL operator != (const GAIA::MATH::VEC3<_ParamDataType>& v) const{return !this->operator == (v);}
			template<typename _ParamDataType> GAIA::BL operator >= (const GAIA::MATH::VEC3<_ParamDataType>& v) const{return !this->operator < (v);}
			template<typename _ParamDataType> GAIA::BL operator <= (const GAIA::MATH::VEC3<_ParamDataType>& v) const{return !this->operator > (v);}
			template<typename _ParamDataType> GAIA::BL operator > (const GAIA::MATH::VEC3<_ParamDataType>& v) const{return GAIA::ALGO::cmp3(GSCAST(const _DataType*)(*this), GSCAST(const _ParamDataType*)(v)) > 0;}
			template<typename _ParamDataType> GAIA::BL operator < (const GAIA::MATH::VEC3<_ParamDataType>& v) const{return GAIA::ALGO::cmp3(GSCAST(const _DataType*)(*this), GSCAST(const _ParamDataType*)(v)) < 0;}
			template<typename _ParamDataType> GAIA::BL operator == (const _ParamDataType& v) const{return GAIA::ALGO::cmp3k((const _DataType*)*this, v) == 0;}
			template<typename _ParamDataType> GAIA::BL operator != (const _ParamDataType& v) const{return !this->operator == (v);}
			template<typename _ParamDataType> GAIA::BL operator >= (const _ParamDataType& v) const{return !this->operator < (v);}
			template<typename _ParamDataType> GAIA::BL operator <= (const _ParamDataType& v) const{return !this->operator > (v);}
			template<typename _ParamDataType> GAIA::BL operator > (const _ParamDataType& v) const{return GAIA::ALGO::cmp3k((const _DataType*)*this, v) > 0;}
			template<typename _ParamDataType> GAIA::BL operator < (const _ParamDataType& v) const{return GAIA::ALGO::cmp3k((const _DataType*)*this, v) < 0;}
			template<typename _ParamDataType> const _DataType& operator [] (const _DataType& index) const{GAIA_AST(index < 3); return this->front_ptr()[index];}
			template<typename _ParamDataType> _DataType& operator [] (const _DataType& index){GAIA_AST(index < 3); return this->front_ptr()[index];}
