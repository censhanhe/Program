...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> GAIA::BL operator == (const VEC2<_ParamDataType>& v) const{return GAIA::ALGORITHM::cmp2((const _DataType*)*this, (const _ParamDataType*)v) == 0;}
