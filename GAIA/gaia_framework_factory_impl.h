...
#define GAIA_MAPPING_CREATEINSTANCEPROC(declcid)\
			...
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_2D_DDRAW_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_2D_GDIPLUS_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX9_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX10_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX11_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL1_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL2_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL3_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES1_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES2_CONTEXT);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES3_CONTEXT);

			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_2D_DDRAW_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_2D_GDIPLUS_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX9_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX10_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX11_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL1_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL2_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL3_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES1_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES2_TEXTUREFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES3_TEXTUREFETCHDATA);

			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_2D_DDRAW_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_2D_GDIPLUS_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX9_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX10_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX11_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL1_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL2_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL3_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES1_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES2_TARGETFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES3_TARGETFETCHDATA);

			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX9_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX10_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX11_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL1_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL2_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL3_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES1_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES2_VERTEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES3_VERTEXBUFFERFETCHDATA);

			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX9_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX10_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_DX11_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL1_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL2_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GL3_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES1_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES2_INDEXBUFFERFETCHDATA);
			GAIA_MAPPING_CREATEINSTANCEPROC(CLSID_RENDER_3D_GLES3_INDEXBUFFERFETCHDATA);
		}
	};
};
