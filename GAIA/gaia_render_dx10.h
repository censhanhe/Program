#ifndef		__GAIA_RENDER_DX10_H__
#define		__GAIA_RENDER_DX10_H__

namespace GAIA
{
	namespace RENDER
	{
		class Render3DDX10 : public virtual GAIA::RENDER::Render3D
		{
		public:
			typedef Render3DDX10 __MyType;
		...
		public:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_CONTEXT;}
			private:
				ContextDesc m_desc;
			};
		...
		public:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_BRUSH;}
				virtual GAIA::BL SetColor(const GAIA::MATH::ARGB<GAIA::REAL>& cr){return GAIA::False;}
				virtual GAIA::BL GetColor(GAIA::MATH::ARGB<GAIA::REAL>& cr) const{return GAIA::False;}
			private:
				BrushDesc m_desc;
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_FONTFAMILY;}
			private:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_FONTPAINTER;}
			private:
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_TARGET;}
			private:
				TargetDesc m_desc;
			};
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_SHADER;}
			private:
				ShaderDesc m_desc;
			};
			...
			public:
				...
				virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10_TEXTURE;}
			private:
				TextureDesc m_desc;
			};
		...
		public:
			GINL Render3DDX10(){this->init();}
			GINL ~Render3DDX10(){}

			virtual GAIA::FWORK::ClsID GetClassID() const{return GAIA::FWORK::CLSID_RENDER_3D_DX10;}
