...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> MTX43(_ParamDataType v){this->operator = (v);}
			...
			template<typename _ParamDataType> __MyType& operator = (const GAIA::MATH::MTX43<_ParamDataType>& src)
			{
