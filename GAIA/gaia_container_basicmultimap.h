...
namespace GAIA
{
	namespace CTN
	{
		template<typename _DataType, typename _KeyType, typename _SizeType, typename _HeightType, typename _SizeIncreaserType> class BasicMultiMap : public GAIA::Entity
		{
		public:
			class Node
			{
			private:
				friend class GAIA::CTN::BasicMultiMap;
				friend class it;
