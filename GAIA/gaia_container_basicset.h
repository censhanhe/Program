...
namespace GAIA
{
	namespace CTN
	{
		template<typename _DataType, typename _SizeType, typename _HeightType, typename _SizeIncreaserType> class BasicSet : public GAIA::Entity
		{
		public:
		...
		public:
			...
			{
			private:
				friend class GAIA::CTN::BasicSet;
			public:
				GINL it(){}
				GINL virtual ~it(){}
