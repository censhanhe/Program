...
namespace VENUS
{
	...
	public:
		...
		public:
			...
			class TextureRec : public GAIA::Base
			{
			public:
				GAIA_CLASS_OPERATOR_COMPARE(sNameIndex, sNameIndex, TextureRec);
			public:
				VENUS::RenderGL::Texture* pTex;
				GAIA::SIZE sNameIndex;
			};
		public:
			Context();
		...
		public:
			...
			virtual GAIA::BL Commit(GAIA::SIZE sOffsetInBytes, GAIA::SIZE sSize, const GAIA::GVOID* p);
		public:
		...
		public:
			...
			virtual GAIA::BL Commit(GAIA::SIZE sOffsetInBytes, GAIA::SIZE sSize, GAIA::SIZE sMipIndex, GAIA::SIZE sFaceIndex, const GAIA::GVOID* p);
		public:
	...
	public:
		...
		virtual GAIA::BL SetVertexBuffer(VENUS::Render::Context& ctx, const GAIA::CH* pszName, VENUS::Render::VertexBuffer* pVB, GAIA::SIZE sStride, GAIA::SIZE sOffset);
		virtual GAIA::BL SetProgram(VENUS::Render::Context& ctx, VENUS::Render::Program* pProgram);
		virtual GAIA::BL SetTexture(VENUS::Render::Context& ctx, const GAIA::CH* pszName, VENUS::Render::Texture* pTex);
		...
		virtual VENUS::Render::VertexBuffer* GetVertexBuffer(VENUS::Render::Context& ctx, const GAIA::CH* pszName, GAIA::SIZE& sStride, GAIA::SIZE& sOffset);
		virtual VENUS::Render::Program* GetProgram(VENUS::Render::Context& ctx);
		virtual VENUS::Render::Texture* GetTexture(VENUS::Render::Context& ctx, const GAIA::CH* pszName);
		...
		virtual GAIA::BL SetConstant(VENUS::Render::Context& ctx, const GAIA::CH* pszUniformName, const GAIA::F32* p, GAIA::U8 uDimenX, GAIA::U8 uDimenY, GAIA::SIZE sCount);
		virtual GAIA::BL GetConstant(VENUS::Render::Context& ctx, const GAIA::CH* pszUniformName, GAIA::F32* p, GAIA::U8 uDimenX, GAIA::U8 uDimenY, GAIA::SIZE sCount);

		/* Draw function. */
		virtual GAIA::BL SetViewport(const GAIA::MATH::AABR<GAIA::N32>& vp);
		virtual GAIA::BL GetViewport(GAIA::MATH::AABR<GAIA::N32>& vp) const;
		virtual GAIA::BL SetScissor(const GAIA::MATH::AABR<GAIA::N32>& s);
		virtual GAIA::BL GetScissor(GAIA::MATH::AABR<GAIA::N32>& s) const;
